<div class="container-fluid row" style="margin-top: 7rem !important">
    <div class="row">
        ...
        <hr>
        <form method="post" action="<?= base_url('ecommerce/profile/update' . '/' . $user_data->id) ?>" enctype="multipart/form-data">
            <div class="mb-3">
        ...
        <hr>
        <hr>
        <form method="post" action="<?= base_url('ecommerce/profile/photo' . '/' . $user_data->id) ?>" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="photo" class="form-label">Photo</label>
                <input type="file" name="photo" class="form-control" id="photo">
            </div>
            <div class="mb-3">
                <img class="rounded-circle" name="showImage" id="showImage" style="width: 75px; height: 75px;" src="<?= base_url($user_data->photo_path) ?>" alt="profile">
            </div>
            <button class="btn btn-outline-info" type="submit">Update Profile Image</button>
        </form>
        ...
        <form method="post" action="<?= base_url('ecommerce/profile/updates' . '/' . $user_data->id) ?>">
            <div class="mb-3">
        ...
        <form method="post" action="<?= base_url('ecommerce/profile/delete' . '/' . $user_data->id) ?>">
            <div class="mb-3">
        ...
        <form method="post" action="<?= base_url('ecommerce/profile/password' . '/' . $user_data->id) ?>">
            <div class="mb-3">
        ...
        <h6>ROLE SETTINGS</h6>
        <hr>
        <form method="post" action="<?= base_url('ecommerce/profile/role' . '/' . $user_data->id) ?>">
            <div class="mb-3">
